...
public class MemoryPool : IEnumerable, System.IDisposable {
    ...
    public MemoryPool(Object original, int count, Transform parent = null) {
        myParent = parent;
        this.Create(original, count);
    }
    ...
    public PoolItem GetItem(int index) {
        return table[index];
    }
}
